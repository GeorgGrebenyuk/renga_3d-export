...
{
public:
    TextHandler(Renga::IActionPtr pAction, int buttom_link) :
...
Renga::IActionPtr export_data_plugin::CreateAction(Renga::IUIPtr pUI, 
    const std::wstring& displayName, const std::wstring& icon_local_path, int type) //, int type
{
    ...
    addHandler(new TextHandler(pAction, 0));
